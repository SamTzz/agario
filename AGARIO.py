...
def run():
    ...
    if core.getKeyPressList(pygame.K_z):
        core.memory("F_key", core.memory("F_key") + core.memory("z"))
        core.memory("direction", Vector2(core.memory("F_key")))

    if core.getKeyPressList(pygame.K_s):
        core.memory("F_key", core.memory("F_key") + core.memory("s"))
        core.memory("direction", Vector2(core.memory("F_key")))

    if core.getKeyPressList(pygame.K_q):
        core.memory("F_key", core.memory("F_key") + core.memory("q"))
        core.memory("direction", Vector2(core.memory("F_key")))

    if core.getKeyPressList(pygame.K_d):
        core.memory("F_key", core.memory("F_key") + core.memory("d"))
        core.memory("direction", Vector2(core.memory("F_key")))

    core.memory("F_key", Vector2(0, 0))

    if core.memory("centredecercle").y < 0:
        core.memory("direction", Vector2(core.memory("direction").x, core.memory("direction").y+1))

    if core.memory("centredecercle").y > core.WINDOW_SIZE[1]:
        core.memory("direction", Vector2(core.memory("direction").x, core.memory("direction").y-1))

    if core.memory("centredecercle").x < 0:
        core.memory("direction", Vector2(core.memory("direction").x+1, core.memory("direction").y))

    if core.memory("centredecercle").x > core.WINDOW_SIZE[0]:
        core.memory("direction", Vector2(core.memory("direction").x-1, core.memory("direction").y))
